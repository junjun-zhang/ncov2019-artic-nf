...
workflow sequenceAnalysis {
    ...
    emit:
      ...
      trimmed_reads = readTrimming.out
      sorted_aligned_bam = readMapping.out
      mapped = trimPrimerSequences.out.mapped
      ptrim = trimPrimerSequences.out.ptrim
      variants = callVariants.out
      consensus_fa =  makeConsensus.out
      qc_csv = makeQCCSV.out.csv
}
...
workflow ncovIllumina {
    ...
    emit:
      qc_pass = sequenceAnalysis.out.qc_pass
      trimmed_reads = sequenceAnalysis.out.trimmed_reads
      sorted_aligned_bam = sequenceAnalysis.out.sorted_aligned_bam
      ptrim = sequenceAnalysis.out.ptrim
      mapped = sequenceAnalysis.out.mapped
      variants = sequenceAnalysis.out.variants
      consensus_fa =  sequenceAnalysis.out.consensus_fa
      qc_csv = sequenceAnalysis.out.qc_csv
}
